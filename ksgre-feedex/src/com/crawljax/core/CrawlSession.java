...
public class CrawlSession {
	...
	// 已经搜索过的状态
	private static Set<StateVertix> alreadyCheckedStates = new HashSet<>();

	// 探测过程中触发的事件数目
	public static int fireEventNum = 0;
	// 探测状态数
	public static int crawlStateNum = 0;
	...
	public void clearAlreadyCheckedStates() {
		alreadyCheckedStates.clear();
	}

	public void addToAlreadyCheckedStates(StateVertix state) {
		alreadyCheckedStates.add(state);
	}

	public static Set<StateVertix> getAlreadyCheckedStates() {
