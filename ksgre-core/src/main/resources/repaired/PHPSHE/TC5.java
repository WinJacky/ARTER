...
public class TC5 {
    ...
    public void tC5() {
        ...
        driver.findElement(By.xpath("/HTML[1]/BODY[1]/DIV[5]/UL[1]/LI[2]/H3[1]/A[1]")).click();
        driver.findElement(By.xpath("/HTML[1]/BODY[1]/DIV[5]/UL[1]/LI[2]/H3[1]/A[1]")).click();
        driver.findElement(By.name("keyword")).sendKeys("null");
        driver.findElement(By.xpath("/HTML[1]/BODY[1]/DIV[2]/DIV[1]/DIV[1]/A[1]")).click();
        driver.findElement(By.xpath("/HTML[1]/BODY[1]/DIV[3]/DIV[2]/DIV[1]/DIV[4]/DIV[1]/DIV[2]/A[1]")).click();
